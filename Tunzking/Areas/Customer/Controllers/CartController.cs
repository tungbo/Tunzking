...
namespace TunzkingWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new()
            {
                ShoppingCartList = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId.ToString() == userId, includeProperties: "Product"),
                OrderHeader = new()
            };

            foreach (var cart in ShoppingCartVM.ShoppingCartList)
            {
                cart.Price = cart.Product.CurrentPrice;
                cart.EPrice = (cart.Price * cart.Count);
                ShoppingCartVM.OrderHeader.OrderTotal += cart.EPrice;
            }
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _unitOfWork.ApplicationUser.Get(u => u.Id.ToString() == userId);
